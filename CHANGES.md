...
1. Single camera display is full screen.
1. When scrubbing the camera popup, clips load and display during scrub.
1. Single camera view shows live camera whilst clips are loading.
1. Single camera view can scrub over loaded clips whilst others are still loading.
1. Preloads clips in an even distribution so preview can happen earlier.
